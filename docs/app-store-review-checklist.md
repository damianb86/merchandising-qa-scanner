...
- [ ] Scopes are minimal: read_products, read_inventory, read_publications.
...
- [ ] Known limitation disclosed: MVP is visual and Admin-first embedded App Home; future admin product block.

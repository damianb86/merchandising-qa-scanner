export const shops = {
  installed: {
    ...
    scopes: ["read_products","read_inventory","read_publications"],
    installed: true,
  },
  empty: {
...
export const settings = {
  saved: {"workflowName":"Weekly visibility scan","thresholdLabel":"High priority threshold","thresholdDefault":"80","ownerEmail":"catalog-ops@example.com"},
